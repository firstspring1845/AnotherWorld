...
public class ChunkProviderFlow implements IChunkProvider
{
	...
	public ChunkProviderFlow(World world, long seed)
	{
		this.worldObj = world;
	...
	{
		return "FlowLevelSource";
	}

	/**
	 * �X�|�[���ł���mob��List<net.minecraft.src.SpawnListEntry>
	 */
	@Override
				...
				for (int var11 = 127; var11 >= 0; --var11)
				{
					...
					else if (var13 == Block.stone.blockID)
					{
						if (var8 == -1)
						{
							...
							else if (var11 >= horizon - 4 && var11 <= horizon + 1)
							{
